...
/**
 * Esta es una clase abstracta que implementa métodos útiles para todos los menús de la aplicación.
 */
...
public static final String MENSAJE_PREDETERMINADO = "Escoja la opción deseada";
    ...
    protected int mostrarMenu( String nombreMenu, String[] opciones, String textoOpciones )
    {
        ...
        String opcion = pedirCadenaAlUsuario( textoOpciones );
        try
        {
            int opcionSeleccionada = Integer.parseInt( opcion );
            if( opcionSeleccionada > 0 && opcionSeleccionada <= opciones.length )
    ...
    /**
     * Al cerrar la aplicación, se guarda la información del programa en un archivo llamado nueva_galeria.json en la carpeta datos usando la clase Saver.
