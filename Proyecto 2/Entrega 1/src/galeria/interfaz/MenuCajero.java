...
/**
 * Este es el menú que verá un cajero al iniciar sesión.
...
public class MenuCajero extends MenuEmpleado {
	...
	/**
	 * Esta función muestra el menú del cajero y ejecuta las funciones correspondientes según la respuesta del usuario.
	 */
	...
	/**
	 * Esta función registra una oferta de subasta como un pago con modalidad venta directa.
	 */
	...
	/**
	 * Esta función registra una oferta de subasta como un pago con modalidad subasta
	 */
	...
	/**
	 * Esta función agrega un pago a la lista de pagos del administrador.
	 * Se debe ejecutar al final de RegistrarPagoPorXXX.
	 */
