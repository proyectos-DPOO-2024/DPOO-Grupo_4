...
/**
 * Esta clase representa una solicitud de extensión de tope de compras.
 * Se debe crear y guardar en la lista correspondiente (en el menú administrador) cuando un cliente solicite una extensión.
 */
