...
public class Impresiones extends Pieza
{
	...
	public Impresiones(String nombrePieza, String nombreArtista, String loginPropietario,
	...
	{
		super(nombrePieza, nombreArtista, Pieza.IMPRESION, loginPropietario, fechaTerminoConsignacion, precioVentaFija,
