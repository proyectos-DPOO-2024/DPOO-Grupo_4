...
/**
 * Esta clase cobija los elementos comunes a todos los tipos de pieza
 * Además, se le asigna un entero a cada tipo de pieza que ayuda la hora de cargar y guardar las piezas.
 */
public abstract class Pieza {
	...
	public void cambiarEstadoPosesion() {
		if (enPosesion) enPosesion = false;
		else enPosesion = true;
	}
